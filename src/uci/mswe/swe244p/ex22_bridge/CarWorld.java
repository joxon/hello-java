...
class CarWorld extends JPanel {
  ...
  public CarWorld() {
    ...
    redCar = toolkit.getImage("src/uci/mswe/swe244p/ex22_bridge/image/redcar.gif");
    tracker.addImage(redCar, 0);
    blueCar = toolkit.getImage("src/uci/mswe/swe244p/ex22_bridge/image/bluecar.gif");
    tracker.addImage(blueCar, 1);
    bridge = toolkit.getImage("src/uci/mswe/swe244p/ex22_bridge/image/bridge1.gif");
