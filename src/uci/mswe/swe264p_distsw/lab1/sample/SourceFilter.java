...
/******************************************************************************************************************
 * File:SourceFilter.java Project: Lab 1 Copyright: Copyright (c) 2020 University of California,
 ...
 *
 * Description: This class serves as an example for how to use the SourceFilterTemplate to create a
 * source filter. This particular filter is a source filter that reads some input from the
 * FlightData.dat file and writes the bytes up stream. Parameters: None Internal Methods: None
 ******************************************************************************************************************/
...
public class SourceFilter extends FilterFramework {
  ...
  public void run() {
    ...
    try {
      ...
      /***********************************************************************************
       * Here we read the data from the file and send it out the filter's output port one byte at a
       * time. The loop stops when it encounters an EOFException.
       ***********************************************************************************/
      while (true) {
