...
/******************************************************************************************************************
 * File:FilterFramework.java Project: Assignment 1 Copyright: Copyright (c) 2003 Carnegie Mellon
 ...
 * until the inputport no longer has any data - at which point the filter finishes up any work it
 ...
 * port.
 *
 * FilterFramework: This is a reference to the filter that is connected to the instance filter's
 * input port. This reference is to determine when the upstream filter has stopped sending data
 * along the pipe.
 *
 * Internal Methods:
 *
 * public void Connect( FilterFramework Filter ) public byte ReadFilterInputPort() public void
 * WriteFilterOutputPort(byte datum) public boolean EndOfInputStream()
 *
 ******************************************************************************************************************/
