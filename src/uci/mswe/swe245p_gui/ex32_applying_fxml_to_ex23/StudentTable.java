...
public class StudentTable extends TableView<Student> implements Initializable {
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    ...
    columnId.setOnEditCommit(e -> {
      ...
      if (!newId.matches("\\d+")) {
        ...
        new Alert(Alert.AlertType.ERROR, "Invalid student ID. Please retry.", ButtonType.OK)
            .showAndWait();
        return;
      }
